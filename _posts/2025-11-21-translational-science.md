...
PaperTok은 “AI가 대신 만든 콘텐츠”가 아니라, 연구자가 ‘감독’처럼 AI가 만든 초안을 다듬는 새로운 협업 구조를 제시한다. 평가 결과, PaperTok으로 만든 영상은 기존 PDF-to-video 방식보다 훨씬 몰입도가 높았다. 이 연구는 학술 지식이 새로운 매체로 진화하는 방식을 제시하며, AI가 연구 커뮤니케이션의 미래에서 어떤 역할을 해야 하는지 질문을 던진다.
