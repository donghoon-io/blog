...
사실이다. 우리 둘 다 학부 때는 미친 듯이 논문을 쏟아냈고, 그게 좋은 일이라고만 생각했다. 생각해보면 지금도 논문을 다작하려고 하면 할 수 있을 것 같다. 하지만 지금은 유명한 지도교수 이름에 먹칠하지 않으려 좀 더 신중하게 논문을 내고 있고, 이에 자연스럽게 개수가 줄어들어 버렸다.
